...
class train:
    ...
    class NLTKPreprocessor(BaseEstimator, TransformerMixin):
        ...
        def vectorize(self, doc):
            ...
            """
            save_path = "training_data/text/padding.pickle"
    ...
    def load_google_vec(self):
        ...
        wget.download(url, 'training_data/text/GoogleNews-vectors.bin.gz')
        return KeyedVectors.load_word2vec_format(
            'training_data/text/GoogleNews-vectors.bin.gz',
            binary=True)
